...
document.addEventListener("DOMContentLoaded",async()=>{
  ...
  try{
    if(!firebaseReady) throw new Error("Configuração do Firebase não carregada. Edite js/config.js.");
